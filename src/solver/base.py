...
class BaseSolver(Constfuncs):
    def __init__(self, args):
        ...
        logging.debug(f'solving for {self.nftP.N} buyers and {self.nftP.M} NFTs, {self.nft_attributes.shape[-1]} attributes')
    ...
    def count_results(self):
        ...
        for batch_users in tqdm(make_batch_indexes(self.nftP.N, 100, True), ncols=88, desc='iter over batch user to count_results', leave=False, total=self.nftP.N// 100 +1):
